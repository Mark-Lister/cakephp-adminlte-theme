  ...
  <div class="navbar-custom-menu">
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <?php echo $this->Html->image('profile/' . $this->request->session()->read('Auth.User.id') . '.jpg', array('class' => 'user-image', 'alt' => 'User Image')); ?>
          <span class="hidden-xs"><?=$this->request->session()->read('Auth.User.name');?></span>
        </a>
        <ul class="dropdown-menu">
          <!-- User image -->
          <li class="user-header">
            <?php echo $this->Html->image('profile/' . $this->request->session()->read('Auth.User.id') . '.jpg', array('class' => 'img-circle', 'alt' => 'User Image')); ?>
